...
# ALLOWED_HOSTS = ['77466924.tbcstudentserver.com', 'www.77466924.tbcstudentserver.com']
...
TEMPLATES = [
    {
        ...
        'DIRS':  [
            BASE_DIR / "templates",  # This tells Django where to find the templates
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR / "static",  # This tells Django where to find your static files
]
